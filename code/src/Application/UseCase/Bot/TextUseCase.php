...
class TextUseCase
{
    ...
    public function getHowUseText(): string
    {
        ...
        $text .= "\n\n<b>3.</b>  Укажите имя человека - если это день рождения. В ином случае имя события, заметки.";
        ...
        $text .= "\n\n<b>6.</b>  В случае уведомления в группе - выберите группу из списка (в которые добавлен бот)";
